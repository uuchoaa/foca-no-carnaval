...
Data extraction for https://www.olinda.pe.gov.br/programacao-do-carnaval-2026-coloca-todo-mundo-na-folia-em-olinda/
...
```bash
npm test -- sites/olinda-pe-gov-br/test/extract-list.test.js
```
...
```bash
npx npm run snapshot:url <detail-url> sites/olinda-pe-gov-br/test/__fixtures__/detail.html --sanitize
```
