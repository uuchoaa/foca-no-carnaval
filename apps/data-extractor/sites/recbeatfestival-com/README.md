...
Data extraction for https://recbeatfestival.com/#programacao
...
```bash
npm test -- sites/recbeatfestival-com/test/extract-list.test.js
```
...
```bash
npx npm run snapshot:url <detail-url> sites/recbeatfestival-com/test/__fixtures__/detail.html --sanitize
```
